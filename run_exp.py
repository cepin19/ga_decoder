...
with open("{}.trans".format(f)) as trans, open("{}.scores".format(f)) as scores, open("{}.ref".format(f)) as refs, open("{}.src".format(f)) as srcs, open("{}.tgt_words_exp".format(f)) as dict_tgts:
